export const adapters = [
  ...
  },
  {
    ...
    endpoints: [
      ...
      endpoint('/shortcut/workflows', 'Read Shortcut workflow', 'Reads Shortcut workflow records. The REST API does not expose workflow create, update, or delete operations.', [], { name: str('Workflow name.'), description: str('Workflow description.') }, undefined, { operations: [], createSupported: false }),
    ],
  },
  {
    slug: 'slack',
