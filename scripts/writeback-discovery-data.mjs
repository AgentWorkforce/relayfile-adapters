export const adapters = [
  ...
  },
  {
    ...
    endpoints: [
      ...
      endpoint('/telegram/callback-queries/new.json', 'Answer Telegram callback query', 'Answers an inline keyboard callback query.', [], telegramCallbackAnswerProps(), { callback_query_id: 'replace-callback-query-id', text: 'Done' }, { required: ['callback_query_id'] }),
