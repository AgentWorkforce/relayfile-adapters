...
- `@relayfile/relay-helpers` now normalizes Reddit subreddit parameters to the adapter's lowercase canonical paths, including optional `r/` prefixes, and rejects values that normalize to an empty subreddit.
