import type { RedisConfig, FetchContentClient, JsonObject, StorageBridgeEvent } from './types.js';

export async function fetchContent(event: StorageBridgeEvent, config: RedisConfig, client: FetchContentClient = {}): Promise<Uint8Array | null> {
