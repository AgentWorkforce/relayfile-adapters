...
export type StorageBridgeEvent = Omit<CoreStorageBridgeEvent, 'source' | 'metadata'> & { readonly source: 'postgres'; readonly metadata: JsonObject };
...
export interface FetchContentClient {
  getObject?(event: StorageBridgeEvent, config: PostgresConfig): Promise<string | Uint8Array | null>;
}
