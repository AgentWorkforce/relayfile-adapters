...
export type StorageBridgeEvent = Omit<CoreStorageBridgeEvent, 'source' | 'metadata'> & { readonly source: 'sharepoint'; readonly metadata: JsonObject };
...
export interface FetchContentClient {
  getObject?(event: StorageBridgeEvent, config: SharepointConfig): Promise<string | Uint8Array | null>;
}
