import type { SharepointConfig, FetchContentClient, JsonObject, StorageBridgeEvent } from './types.js';

export async function fetchContent(event: StorageBridgeEvent, config: SharepointConfig, client: FetchContentClient = {}): Promise<Uint8Array | null> {
