import type { AzureBlobConfig, FetchContentClient, JsonObject, StorageBridgeEvent } from './types.js';

export async function fetchContent(event: StorageBridgeEvent, config: AzureBlobConfig, client: FetchContentClient = {}): Promise<Uint8Array | null> {
