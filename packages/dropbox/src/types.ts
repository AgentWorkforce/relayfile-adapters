...
export type StorageBridgeEvent = Omit<CoreStorageBridgeEvent, 'source' | 'metadata'> & { readonly source: 'dropbox'; readonly metadata: JsonObject };
...
export interface FetchContentClient {
  getObject?(event: StorageBridgeEvent, config: DropboxConfig): Promise<string | Uint8Array | null>;
}
