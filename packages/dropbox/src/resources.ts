...
export const resources = [
  ...
  },
  {
    ...
    pathPattern: /^\/dropbox\/shared-folders\/(?:(?!_index\.json$)[^\/]+\.json|by-id\/[^\/]+\.json)$/,
    idPattern: /^[A-Za-z0-9_.:-]+$/,
  ...
  },
  {
    ...
    pathPattern: /^\/dropbox\/shared-links\/(?:(?!_index\.json$)[^\/]+\.json|by-id\/[^\/]+\.json)$/,
    idPattern: /^[A-Za-z0-9_.:-]+$/,
  ...
  },
  {
    ...
    pathPattern: /^\/dropbox\/cursors(?:\/(?!_index\.json$)[^\/]+\.json)?$/,
    idPattern: /^[A-Za-z0-9_.:-]+$/,
