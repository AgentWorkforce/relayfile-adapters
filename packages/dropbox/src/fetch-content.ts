import type { DropboxConfig, FetchContentClient, JsonObject, StorageBridgeEvent } from './types.js';

export async function fetchContent(event: StorageBridgeEvent, config: DropboxConfig, client: FetchContentClient = {}): Promise<Uint8Array | null> {
