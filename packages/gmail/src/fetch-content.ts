import type { GmailConfig, FetchContentClient, JsonObject, StorageBridgeEvent } from './types.js';

export async function fetchContent(event: StorageBridgeEvent, config: GmailConfig, client: FetchContentClient = {}): Promise<Uint8Array | null> {
