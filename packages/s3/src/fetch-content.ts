import type { S3Config, FetchContentClient, JsonObject, StorageBridgeEvent } from './types.js';

export async function fetchContent(event: StorageBridgeEvent, config: S3Config, client: FetchContentClient = {}): Promise<Uint8Array | null> {
