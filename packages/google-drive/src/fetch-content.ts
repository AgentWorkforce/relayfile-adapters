import type { GoogleDriveConfig, FetchContentClient, JsonObject, StorageBridgeEvent } from './types.js';

export async function fetchContent(event: StorageBridgeEvent, config: GoogleDriveConfig, client: FetchContentClient = {}): Promise<Uint8Array | null> {
