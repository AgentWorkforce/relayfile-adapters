import type { OnedriveConfig, FetchContentClient, JsonObject, StorageBridgeEvent } from './types.js';

export async function fetchContent(event: StorageBridgeEvent, config: OnedriveConfig, client: FetchContentClient = {}): Promise<Uint8Array | null> {
