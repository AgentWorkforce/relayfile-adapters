...
- `/slack/users/<userId>/messages/<messageTs>/replies/<replyTs>/meta.json` - Threaded replies in a 1:1 direct message (directory record; legacy flat `<replyTs>.json` still readable).
