...
export type StorageBridgeEvent = Omit<CoreStorageBridgeEvent, 'source' | 'metadata'> & { readonly source: 'box'; readonly metadata: JsonObject };
...
export interface FetchContentClient {
  getObject?(event: StorageBridgeEvent, config: BoxConfig): Promise<string | Uint8Array | null>;
}
