import type { BoxConfig, FetchContentClient, JsonObject, StorageBridgeEvent } from './types.js';

export async function fetchContent(event: StorageBridgeEvent, config: BoxConfig, client: FetchContentClient = {}): Promise<Uint8Array | null> {
