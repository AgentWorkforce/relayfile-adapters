...
Path: `/notion/databases/{databaseId}/pages/new.json`
Schema: `/notion/databases/{databaseId}/pages/new.schema.json`
Example: `/notion/databases/{databaseId}/pages/new.example.json`
