...
describe('path mapping', () => {
  ...
  it('maps database page paths', () => {
    assert.strictEqual(notionDatabasePagePath('db-1', 'page-1'), '/notion/databases/db-1/pages/page-1/meta.json');
  ...
  it('maps standalone page paths', () => {
    assert.strictEqual(notionStandalonePagePath('page-1'), '/notion/pages/page-1/meta.json');
