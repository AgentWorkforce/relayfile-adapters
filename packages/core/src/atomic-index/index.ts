...
export interface VfsLike {
  ...
  put?(path: string, content: string, options?: { baseRevision?: string }): Promise<unknown> | unknown;
  read?(path: string): Promise<unknown> | unknown;
  readFile?(path: string): Promise<unknown> | unknown;
  set?(path: string, content: string, options?: { baseRevision?: string }): Promise<unknown> | unknown;
  stat?(path: string): Promise<unknown> | unknown;
  upsert?(path: string, content: string, options?: { baseRevision?: string }): Promise<unknown> | unknown;
  write?(path: string, content: string, options?: { baseRevision?: string }): Promise<unknown> | unknown;
  writeFile?(path: string, content: string, options?: { baseRevision?: string }): Promise<unknown> | unknown;
}
