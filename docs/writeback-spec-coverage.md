...
| gitlab | None | 0 | 9 | Inline JS schemas for issue and merge-request create/update, branch creation, merge-request accept/close/reopen, discussions, and issue notes. |
